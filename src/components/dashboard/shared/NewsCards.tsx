      ...
      {news.map((item, idx) => {
        ...
        return (
          <a
            ...
            className="flex-1 min-w-0 p-6 rounded-[2.5rem] border bg-white shadow-lg transition-all hover:-translate-y-1 duration-300 group"
          >
            <div className={`w-12 h-12 ${iconColor} rounded-2xl flex items-center justify-center mb-4 shadow-inner`}>
              <Newspaper size={24} />
            </div>
            <div className="flex items-start gap-2">
              <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] flex-1 leading-relaxed">
                {item.title}
              </p>
